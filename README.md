...
2. [Install Hungarian Language Pack](#2-how-to-install-hungarian-language-pack)
3. [How to active Hungarian language pack](#3-how-to-active-hungarian-language-pack)
...
## 3. How to active Hungarian language pack {#active}
