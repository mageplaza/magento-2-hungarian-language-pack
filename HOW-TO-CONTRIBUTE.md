# How to contribute Hungarian Language pack
...
- This file [crowdin_pull.csv](https://github.com/mageplaza/magento-2-hungarian-language-pack/blob/master/crowdin_pull.csv) has been pulled from [Crowdin](https://crowdin.com/project/magento-2) daily, so you should not change/edit the file.

- [github_contributions.csv](https://github.com/mageplaza/magento-2-hungarian-language-pack/blob/master/github_contributions.csv) has been contributed by Mageplaza community.

- We will merge two files: crowdin_pull.csv and github_contributions.csv into [hu_HU.csv](https://github.com/mageplaza/magento-2-hungarian-language-pack/blob/master/hu_HU.csv). Your Magento 2 store will use this csv file.
