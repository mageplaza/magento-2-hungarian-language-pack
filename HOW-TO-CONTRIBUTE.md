...
#### Suggestions
- You can copy any part of `hu_HU.csv` and paste to `github_contributions.csv` then translate it.
- Please do not copy all lines in `hu_HU.csv`, we will not approve it in this case.
